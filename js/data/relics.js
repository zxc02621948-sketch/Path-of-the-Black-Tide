const RELICS = [
  ...
  },
  {
    ...
    rarity: 'rare',
    fusable: true,
    desc: '持有者使用劍系武器主戰時，低骰視為刺劍。刺劍命中後觸發連擊：第一次連擊機率 80%，之後每次連擊機率 -20%；連擊傷害為本次傷害的 50%。',
...
const RELIC_FUSED_DESCS = {
  ...
  silver_bee_pin: '持有者使用劍系武器主戰時，低骰視為刺劍。刺劍命中後觸發連擊：第一次連擊機率 90%，之後每次連擊機率 -10%，最低 10%；連擊傷害為本次傷害的 50%。',
