const RELICS = [
  ...
  },
  {
    ...
    poolWeight: 0.5,
    fusable: true,
    desc: '攻擊骰最終為 6 時傷害 +2；每場戰鬥前 1 次可將小於等於 3 的攻擊骰面改為 6。',
...
const RELIC_FUSED_DESCS = {
  ...
  lucky_star: '攻擊骰最終為 6 時傷害 +2；每場戰鬥前 2 次可將小於等於 3 的攻擊骰面改為 6。若使用 12 面骰，攻擊骰最終為 12 時傷害 +4；每場戰鬥前 2 次骰到 6 時有 50% 機率改為 12。',
