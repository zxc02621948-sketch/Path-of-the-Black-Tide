...
const RELIC_FUSED_DESCS = {
  war_banner: '主戰攻擊前，可選擇舉起戰爭旗，旗面自動決定。戰吼面：全隊擊中傷害依旗階 +1/+2/+3。創傷面：每回合第一次擊中時施加 1/2/3 層傷口。融合後此旗不會舉旗失敗；非執旗者舉起時直接成為 2 階，執旗者舉起時 1-4 為 2 階，5-6 為 3 階。',
  eagle_banner: '主戰攻擊前，可選擇舉起鷹眼旗，旗面自動決定。破綻面：每回合附加 1 個鷹眼破綻；命中該破綻時 1/2/3 階額外傷害 +0/+2/+3。原生面：命中任一原生弱點時傷害 +3/+3/+4；2 階若最終骰面大於 3，新增 1 個鷹眼暫時原生弱點 2 回合；3 階若最終骰面大於 2，新增 1 個鷹眼暫時原生弱點 3 回合。融合後此旗不會舉旗失敗；非執旗者舉起時直接成為 2 階，執旗者舉起時 1-4 為 2 階，5-6 為 3 階。',
