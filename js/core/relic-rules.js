...
const RelicRules = {
  ...
  fusionBonusDesc(relic) {
    const map = {
      ...
      pain_mask: '傷口達到 15 層時引爆並消耗所有傷口，每層造成 2 點固定傷害。',
      pain_splinter_badge: '傷口 5 層以上時額外傷害提高為 30%，且傷口上限提高為 20 層。',
      black_iron_crown: '主動討伐黑暗怪時，全隊對黑暗怪造成的傷害 +10%，至少 +1。',
      wager_dice: '可押注 4 個骰面；押中仍為該擊傷害 +4，懊悔仍最多 3 層。',
    };
    return map[relic?.id] || '';
  },
