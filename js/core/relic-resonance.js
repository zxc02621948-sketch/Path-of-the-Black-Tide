      ...
      if (this._hasDodecaFateDice(char)) {
        active.push({
          ...
          effect: {
            ...
            desc: '攻擊骰改為 1d12；若使用賭命骰子，可額外押注 3 個骰面；搏命者單數刷新原生弱點，其他職業只有 7、9、11 會刷新；命中原生弱點或視為命中原生弱點時最終傷害 x3；最終骰值等於原生弱點 x2 時額外觸發共鳴弱點；自然 12 觸發時改為 x4。',
          },
        });
      }
      if (this._hasDodecaLuckyDice(char)) {
        active.push({
          ...
          effect: {
            ...
            desc: '攻擊骰改為 1d12且不命中原生弱點；若使用賭命骰子，可額外押注 3 個骰面；搏命者單數刷新破綻，7、9、11 刷新 2 個；其他職業只有 7、9、11 會刷新 1 個；最終骰值等於或為破綻倍數時視為命中破綻 +3；每個符合倍數的破綻額外 +8，破綻 1 會使所有骰面符合倍數。',
          },
        });
      }
