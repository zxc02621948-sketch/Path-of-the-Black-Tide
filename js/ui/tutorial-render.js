...
const RenderTutorial = {
    ...
    return [
      {
        ...
        kicker: '先活下來，再變強',
        icon: '探索',
        eventBackdrop: 'assets/ui/guide-explore-map.png',
        eventBackdropClass: 'tutorial-backdrop-explore',
        eventPage: true,
        body: [
      ...
      },
      {
        ...
        kicker: '流派成形的核心',
        icon: '聖物',
        eventBackdrop: 'assets/ui/guide-relics-glow.png',
        eventBackdropClass: 'tutorial-backdrop-relics',
        eventPage: true,
        body: [
          '聖物會改變戰鬥規則，是流派成形的核心。',
      ...
      },
      {
        ...
        kicker: '補上角色的手感',
        icon: '裝備',
        eventBackdrop: 'assets/ui/guide-equipment-cache.png',
        eventBackdropClass: 'tutorial-backdrop-equipment',
        eventPage: true,
        body: [
      ...
      },
      {
        ...
        kicker: '看懂地圖上的追獵倒數',
        icon: '黑夜',
        eventBackdrop: 'assets/ui/guide-dark-avatar-countdown.png',
        eventBackdropClass: 'tutorial-backdrop-dark-avatar',
        eventPage: true,
        eventArt: true,
        darkTokens: true,
      ...
      },
      {
        ...
        kicker: '回到探險筆記',
        icon: '筆記',
        eventBackdrop: 'assets/ui/guide-notes-book.png',
        eventBackdropClass: 'tutorial-backdrop-notes',
        eventPage: true,
        body: [
  ...
  showTutorial(pageIndex = 0) {
    ...
    Game._openModal({
      ...
      typeText: false,
      tutorialModal: true,
      tutorialBackdrop: !!page.eventBackdrop,
      eventBackdrop: page.eventBackdrop || '',
      eventBackdropClass: page.eventBackdropClass || '',
      introFx: page.eventBackdrop ? 'scene' : '',
    });
  },
  ...
  _tutorialPageHtml(page, index, total) {
    ...
    const pageClass = `${page.eventPage ? ' tutorial-page-event' : ''}${page.pageClass ? ` ${page.pageClass}` : ''}`;
    const artHtml = page.eventPage && !page.eventArt ? '' : `<div class="tutorial-art">${art}</div>`;
    return `
      <div class="tutorial-page${pageClass}">
  ...
  _tutorialArtHtml(page) {
    if (page.image) {
      return `<img class="tutorial-art-image ${page.imageClass || ''}" src="${page.image}" alt="">`;
    }
