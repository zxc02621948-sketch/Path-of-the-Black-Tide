  ...
  _resonanceRelatedRules(id) {
    const rules = {
      pain_resonance: [
        ...
        ['裂痛徽記', '爆發共鳴啟動時，裂痛徽記的骰面 6 附加傷口不會觸發。'],
      ...
      dodeca_fate_dice: [
        ...
        ['押注', '賭命骰子押中會提高傷害；懊悔時下次受擊流程受到的傷害 +30%，最多 3 層。'],
    ...
    return [
      {
        ...
        desc: '同身：融合痛苦面具 + 痛苦徽記。',
        body: '持有者攻擊時，目標傷口不提供傷害加成，且裂痛徽記的骰面 6 附加傷口失效；若本次造成傷害，附加等同最終骰面一半（向上取整）的傷口。施加傷口後若目標達到 10 層以上傷口，引爆並消耗所有傷口，每層造成 2 點固定傷害。',
