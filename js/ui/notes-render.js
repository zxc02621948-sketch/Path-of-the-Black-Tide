...
const RenderNotes = {
  ...
  _resonanceRelatedRules(id) {
    const rules = {
      ...
      greatsword_resonance: [
        ...
        ['重劍', '高骰視為重劍；沉鐵劍律不提高觸發率。融合沉鐵劍鞘時，每次重劍命中合計獲得 8 點氣勢；若劍系主戰攻擊未打出重劍，氣勢 -3，最低為 0。'],
      ],
      rapier_resonance: [
        ['刺劍', '低骰視為刺劍；刺劍連擊從第一次連擊就需要判定。銀蜂劍律不再提供保底連擊。'],
      ...
      dodeca_fate_dice: [
        ...
        ['押注', '賭命骰子押中會提高傷害，12 面骰押中時額外再加上本次骰面；懊悔時下次受擊流程受到的傷害 +30%，最多 3 層。'],
  ...
  _weaponDisplay(weapon = {}) {
    const overrides = {
      ...
      dagger: ['匕首', '🗡️', '主戰時，命中弱點與破綻時額外 +2 傷害。'],
  ...
  _itemDisplay(item = {}) {
    const overrides = {
      ...
      leather_patch: ['皮革補片', '🧩', '下一次敵方攻擊傷害 -2。'],
    ...
    return [
      {
        ...
        desc: '同身：融合痛苦面具 + 痛苦徽記。',
        body: '持有者攻擊時，目標傷口不提供傷害加成，且痛苦徽記的附加傷口失效；若本次造成傷害，附加等同最終骰面一半（向上取整）的傷口。施加傷口後若目標達到 10 層以上傷口，引爆並消耗所有傷口，每層造成 2 點固定傷害。',
      ...
      },
      {
        ...
        detail: ['融合沉鐵劍鞘時，每次重劍命中合計獲得 8 點氣勢。若劍系主戰攻擊未打出重劍，氣勢 -3，最低為 0。此共鳴不補重劍觸發率，也不提供低骰刺劍效果。'],
      },
      {
        id: 'rapier_resonance',
        name: '銀蜂劍律',
        ...
        desc: '同身：融合銀蜂針 + 沉鐵劍鞘。',
        body: '沉鐵劍鞘不再觸發重劍，改為強化刺劍。本次刺劍每成功連擊 1 次，後續連擊傷害 +1。',
